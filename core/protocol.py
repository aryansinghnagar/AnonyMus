...
def construct_aad(role: str, seq_num: int, session_id: str, protocol_version: int = 2) -> bytes:
    ...
    return role_byte + struct.pack('>I', seq_num) + truncated_session + bytes([protocol_version])
...
def encrypt_message_v2(dr_session, plaintext: str, role: str, session_id: str,
                       my_private_key_bytes: bytes, peer_public_key_bytes: bytes) -> dict:
    """
...
def decrypt_message_v2(dr_session, payload: dict, role: str, session_id: str,
                       my_private_key_bytes: bytes, peer_public_key_bytes: bytes) -> str:
    """
...
def decrypt_message(key_or_session, iv_b64: str, ct_b64: str, role: str, seq_num: int, session_id: str,
                    my_private_key_bytes: bytes = None, peer_public_key_bytes: bytes = None, payload: dict = None) -> str:
    """
