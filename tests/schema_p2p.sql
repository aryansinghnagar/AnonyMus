...
, my_onion_address TEXT, disappearing_ttl INTEGER, display_name TEXT, dr_state TEXT, peer_kem_public_key TEXT, my_kem_private_key  TEXT, notify_queue_token TEXT, preferred_file_relay TEXT, send_receipts INTEGER DEFAULT 1, profile_id TEXT NOT NULL DEFAULT 'default');
...
CREATE TABLE messages (
    ...
    timestamp INTEGER NOT NULL, expires_at INTEGER, delivery_state TEXT DEFAULT 'sent',
...
, profile_id TEXT NOT NULL DEFAULT 'default', is_channel INTEGER NOT NULL DEFAULT 0);
